...
//application내장객체를 DAO 객체의 생성자로 전ㄷㄹ하여 생성자에서 web.xml의 컨텍스트 초기화
//파라미토를 즉시 읽어올 수 있도록 처리한다
...
//검색어가 있는 경우에만 파라미터를 Map 컬렉션에 저장한다
...
//만약 검색어가 있다면 해당 조건에 맞는 게시물만 카운트 혹은 select 해야한다
...
<body>
	...
	<h2>목록 보기(List)</h2>
	<!-- 검색폼 -->
	<!-- form 태그에 action속성이 없으면 폼값은 현재 페이지로 전송된다. -->
	<form method="get">
	...
	<table border="1" width="90%">
		...
		<%
			...
			//게시물의 출력번호
		int virtualNum = 0;
			//게시물의 갯수만큼, 즉 List컬렉션에 저장된 DTO 객체의 갯수만큼 반복한다.
