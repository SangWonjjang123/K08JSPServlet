...
<!-- 
쿠키
	 :  클라이언트의 상태 정보를 유지하기 위한 기술로 클라이언트의 PC 에
	 파일형태로 저장된다
	 쿠키 하나의 크기는 4kb 이고 ,3000개까지 만들수 있다
 -->
...
*/
Cookie cookie = new Cookie("myvookie","쿠키맛나오");
//쿠키의 경로설정. 컨텍스트루트 경로로 지정하므로 웹애플리케이션 전체에서 사용할수 있다
...
<%
/* 
request 내각객체의 getCookoes() 를 통해 현재 생성된 모든 쿠키를 배열의 형태로 가져온다.
*/
